...
## 🚀 Currently Building @ HACOM

> 🏢 **hacom-holding-dx** — Enterprise digital transformation platform
>
> | Project | Role | Stack | Commits |
> |---------|------|-------|---------|
> | 💬 **chat-web-client** | Lead Frontend | React · TypeScript · TailwindCSS | 440+ |
> | 🔧 **chat-api-service** | Backend Dev | Node.js · Express · MongoDB | 92+ |
> | 👥 **hr-web-client** | Frontend Dev | React · TypeScript | 42+ |
> | 🗄️ **hr-api-service** | Backend Dev | Node.js · PostgreSQL | 28+ |
...
[![GitHub](https://img.shields.io/badge/@minhnhataa-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/minhnhataa)
